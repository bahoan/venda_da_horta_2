...
/**
 * Componente que contém os botões de ação principal (Quero Lotar Meu WhatsApp de Clientes e Pedidos!) e suporte (WhatsApp)
 * 
...
export default function ActionButtons({
  ...
  return (
    <div className={`flex flex-col gap-4 w-full ${className}`}>
      ...
      {/* Botão verde - Quero Lotar Meu WhatsApp de Clientes e Pedidos! */}
      <button 
      ...
      {/* Botão cinza - Dúvidas? Chama no WhatsApp (condicional) */}
      {!showOnlyMainButton && (
        <div className="flex flex-col items-center w-full mt-2">
          ...
          <p className="text-gray-700 text-sm mt-4 text-center">
            Pode chamar! Normalmente respondemos em menos de 2 minutos
          </p>
        </div>
      )}
    </div>
